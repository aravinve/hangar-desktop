...
function Calculator() {
  ...
  return (
    <>
      <div className='flex flex-col bg-body items-center px-4 py-6 justify-center'>
          ...
          <div className='flex-auto px-8 py-10 bg-secondary border-primary rounded-sm shadow-lg'>
